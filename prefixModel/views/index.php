...
<p>This generator generates a model class for the specified database table, and allows a 
	model prefix which is useful when generating models for all tables.</p>
